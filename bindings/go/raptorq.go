...
#cgo linux LDFLAGS: -L${SRCDIR}/../lib -Wl,-Bstatic -lrq_library -Wl,-Bdynamic -ldl -lm -lpthread
#cgo darwin LDFLAGS: -L${SRCDIR}/../lib -lrq_library -framework Security -framework CoreFoundation -lm
#cgo windows LDFLAGS: -L${SRCDIR}/../lib -lrq_library -lws2_32 -luserenv -ladvapi32
